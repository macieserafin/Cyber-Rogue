...
public class Player extends Entity {
    ...
    public void getPlayerImage() {
        try {
            ...
            idle1 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("player/player_idle_1.png"));
            idle2 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("player/player_idle_2.png"));
    ...
    public void update(){
        ...
        if(keyH.upPressed == true || keyH.downPressed == true || keyH.leftPressed == true || keyH.rightPressed == true){
            ...
            spriteCounter++;
            if(spriteCounter > 10) //every 10 frames changes (i guess xd)
            {
                if(spriteNum == 1) {
                    spriteNum = 2;
                }
